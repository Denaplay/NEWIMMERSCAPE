...
const quests = [
  {
    ...
    tags: ['интересные загадки', 'страшный'],
    genre: 'хоррор',
    age: '12+',
    loc: 'м. Профсоюзная',
    time: '60 мин',
...
`,
  ...
  {
    name: 'Рик и Морти',
    tags: ['приключения', 'для всей семьи'],
    genre: 'приключения',
    age: '12+',
    loc: 'м. Профсоюзная',
    time: '60 мин',
...
`,
  ...
  },
  {
    ...
    tags: ['детективный', 'для подростков'],
    genre: 'детектив',
    age: '10+',
    loc: 'м. Профсоюзная',
    time: '60 мин',
...
`,
  ...
  },
  {
    ...
    price: 12000,
    oldPrice: 17000,
    image: 'imeges/horror-vecher/1.webp'
  },
  {
    name: 'Among Us',
...
function renderQuests() {
  ...
  const filtered = quests.filter(q => {
    ...
    const notHorrorSpecial = !['Хоррор-свидание', 'Хоррор-вечер'].includes(q.name);
    return locMatch && notAction && notHorrorSpecial;
  });
